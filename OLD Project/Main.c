...
int main(int argc, char *argv[])
{
    ...
    GdkPixbuf *scaled_pixbuf1 = gdk_pixbuf_scale_simple(pixbuf1, 40, 40, GDK_INTERP_BILINEAR);
    GdkPixbuf *scaled_pixbuf2 = gdk_pixbuf_scale_simple(pixbuf2, 40, 40, GDK_INTERP_BILINEAR);
